...
/**
    ...
    case 2:
      ...
      int messagesC = 1;
      System.out.println("enter number from 1-10 to access messages");
      ...
      switch (message){ 
	         ...
	         break;
               ...
               case 7:
                    ...
                    System.out.println("enter  1 or 2 to access function");
                     int MessagesSettings = input.nextInt();
                      switch (MessagesSettings){
                          case 1 :
                              System.out.println("set");
   			      System.out.println("enter  1 _ 3 to access function");
   ...
   case 4:
        ...
        System.out.println("enter  1 - 8 to access function");
          int callRegister = input.nextInt();
              switch (callRegister){
					...
					case 5:		
			                 ...
			                 System.out.println("enter  1 - 5 to access function");
                    			 int ShowCallsDuration  = input.nextInt();
                      				switch (ShowCallsDuration){
							 case 1 :
							 ...
							 case 3 :		
			                		  ...
			                		  break;
							 case 4 :		
                                        		 System.out.println("Dailled calls' duration");
			                		  break;
							 case 5 :		
					...
					case 6:		
			                 ...
			                 System.out.println("enter  1 - 3 to access function");
                    			 int ShowCallsCosts  = input.nextInt();
                      				switch (ShowCallsCosts){
							 case 1 :
					...
					case 7:		
			                 ...
			                 System.out.println("enter  1 - 2 to access function");
  ...
  System.out.println ("ENTER ANY NUMBER FROM 1 - 13 TO ACCESS FUNCTION or -1 to quit ");
